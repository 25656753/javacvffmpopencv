...
public class MyGlRender implements GLSurfaceView.Renderer {
    ...
    private final String TAG="MyGlRender";
    ...
    public void setFrameDataa(int w, int h, Buffer by) {
        this.w = w;
        this.h = h;
        this.y = by;
      ;
    ...
    private void renderYuv() {
        if (w > 0 && h > 0 && y != null ) {
            ...
            GLES20.glTexImage2D(GLES20.GL_TEXTURE_2D, 0, GLES20.GL_RGB, w, h, 0, GLES20.GL_UNSIGNED_BYTE, GLES20.GL_RGB, y);
