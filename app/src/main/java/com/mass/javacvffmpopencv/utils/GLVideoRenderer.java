package com.mass.javacvffmpopencv.utils;
...
import com.mass.javacvffmpopencv.R;
...
public class GLVideoRenderer implements GLSurfaceView.Renderer
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        String vertexShader =GlShaderUtils.readRawTextFile(context, R.raw.vetext_sharder);
        String fragmentShader = GlShaderUtils.readRawTextFile(context, R.raw.fragment_sharder);
        ...
        GlShaderUtils.checkGlError("glBindTexture mTextureID");
